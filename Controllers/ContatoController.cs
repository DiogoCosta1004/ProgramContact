...
using ProgramContact.Repositório;
using System.Collections.Generic;

namespace ProgramContact.Controllers
{
    public class ContatoController : Controller
    {
        ...
        public IActionResult Alterar(ContatoModel contato)
        {
            ...
            {
                TempData["MensagemErro"] = $"Ops, não conseguimos atualizar o seu contatto, tente novamente, detalhe do erro:{erro.Message}";
                return RedirectToAction("Index");
            }
        }
    }
